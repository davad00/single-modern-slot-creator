...
# Vendored layout: scripts live one directory above tests/ (upstream keeps them
# under skills/generate2dsprite/scripts/).
SCRIPT_PATH = Path(__file__).resolve().parents[1] / "generate2dsprite.py"
